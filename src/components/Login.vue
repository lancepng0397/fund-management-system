<template>
   <main class="container my-4">
    <div class="d-header d-flex justify-content-center gap-4 align-items-center mb-4">
      <div class="d-title">
        <h2 class="display-6 fw-light mb-0">Login</h2>
      </div>
    </div>
      ...
      <div class="row border rounded-5 bg-white shadow box-area">
        ...
        <div class="col-md-6 right-box">
          ...
          <form @submit.prevent="login" name="login-form">
            ...
            <div class="input-group mb-3">
              <input v-model="password" type="password" name ="password" class="form-control form-control-lg bg-light fs-6" placeholder="Password">
            </div>
            <div class="input-group mb-3">
